...
void SoftIMAADPCM::initPorts() {
    ...
    def.format.audio.cMIMEType = const_cast<char *>("video/raw");
    def.format.audio.pNativeRender = NULL;
    def.format.audio.bFlagErrorConcealment = OMX_FALSE;
    ...
    switch (index) {
        case OMX_IndexParamAudioPortFormat:
        {
            ...
            formatParams->eEncoding =
                ...
                ? (OMX_AUDIO_CODINGTYPE)OMX_AUDIO_CodingIMAADPCM : OMX_AUDIO_CodingPCM;
    ...
    switch (index) {
        ...
        case OMX_IndexParamAudioPortFormat:
        {
            ...
            if ((formatParams->nPortIndex == 0
                && formatParams->eEncoding != (OMX_AUDIO_CODINGTYPE)OMX_AUDIO_CodingIMAADPCM)
