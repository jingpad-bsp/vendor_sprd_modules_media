...
private:
    ...
    FT_MP4Dec_get_iova mMP4DecGetIOVA;
    FT_MP4Dec_free_iova mMP4DecFreeIOVA;
    FT_MP4Dec_get_IOMMU_status mMP4DecGetIOMMUStatus;
    FT_Mp4NeedToSwitchToSwDecoder mMp4NeedToSwitchToSwDecoder;
    bool mFrameDecoded;
