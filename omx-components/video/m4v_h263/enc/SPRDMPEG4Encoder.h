...
private:
    ...
    FT_MP4Enc_get_iova   mMP4EncGetIOVA;
    FT_MP4Enc_free_iova   mMP4EncFreeIOVA;
    FT_MP4Enc_get_IOMMU_status  mMP4EncGetIOMMUStatus;
    FT_MP4Enc_Need_Align  mMP4Enc_NeedAlign;
    FT_MP4Enc_ExtraMemSize mMP4Enc_ExtraMemSize;
