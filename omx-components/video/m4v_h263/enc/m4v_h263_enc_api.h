...
typedef struct {
  ...
  uint32 QP_IVOP;  // first I frame's QP; 1 ~ 31, default QP value if the Rate
                   // Control is disabled
  uint32 QP_PVOP;  // first P frame's QP; 1 ~ 31, default QP value if the Rate
                   // Control is disabled
...
//Note:
/*****************************************************************************/
MMEncRet MP4EncGetCodecCapability(MP4Handle *mp4Handle,
...
//Note:
/*****************************************************************************/
MMEncRet MP4EncStrmEncode(MP4Handle *mp4Handle, MMEncIn *pInput,
                          MMEncOut *pOutput);
...
int MP4Enc_get_iova(MP4Handle *mp4Handle, int fd, unsigned long *iova, size_t *size);

int MP4Enc_free_iova(MP4Handle *mp4Handle, unsigned long iova, size_t size);

int MP4Enc_get_IOMMU_status(MP4Handle *mp4Handle);
uint32 MP4Enc_ExtraMemSize (MP4Handle *mp4Handle,int width,int height);


typedef MMEncRet (*FT_MP4EncGetCodecCapability)(MP4Handle *mp4Handle,
                                                MMEncCapability *Capability);
typedef MMEncRet (*FT_MP4EncPreInit)(MP4Handle *mp4Handle,
                                     MMCodecBuffer *pInterMemBfr);
typedef MMEncRet (*FT_MP4EncInit)(MP4Handle *mp4Handle,
                                  MMCodecBuffer *pExtraMemBfr,
...
typedef MMEncRet (*FT_MP4EncStrmEncode)(MP4Handle *mp4Handle, MMEncIn *pInput,
                                        MMEncOut *pOutput);
...
typedef int (*FT_MP4Enc_get_iova)(MP4Handle *mp4Handle, int fd, unsigned long *iova, size_t *size);

typedef int (*FT_MP4Enc_free_iova)(MP4Handle *mp4Handle, unsigned long iova, size_t size);

typedef int (*FT_MP4Enc_get_IOMMU_status)(MP4Handle *mp4Handle);
typedef int (*FT_MP4Enc_Need_Align)(MP4Handle *mp4Handle);
typedef uint32 (*FT_MP4Enc_ExtraMemSize)(MP4Handle *mp4Handle,int width,int height);
/**----------------------------------------------------------------------------*
**                         Compiler Flag                                      **
**----------------------------------------------------------------------------*/
#ifdef __cplusplus
