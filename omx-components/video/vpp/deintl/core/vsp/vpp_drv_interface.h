...
#else
#define VSP_DEINTELACE_OFF  (0x0800-0x1000)
#define VSP_CFG0_OFF (0x080c-0x1000)
#define VSP_CFG1_OFF (0x0810-0x1000)
#define VSP_CFG2_OFF (0x0814-0x1000)
#define VSP_CFG3_OFF (0x0818-0x1000)
#define VSP_CFG4_OFF (0x081c-0x1000)
#define VSP_CFG5_OFF (0x0820-0x1000)
#define VSP_CFG6_OFF (0x0824-0x1000)
#define VSP_CFG7_OFF (0x0828-0x1000)
#define VSP_CFG8_OFF (0x082c-0x1000)
#define VSP_CFG9_OFF (0x0830-0x1000)
#define VSP_CFG10_OFF (0x0834-0x1000)
#endif
