...
**                           Function Prototype                               **
**----------------------------------------------------------------------------*/
void VP8GetVideoDimensions(VPXHandle *vpxHandle, int32 *display_width,
                           int32 *display_height);
void VP8GetBufferDimensions(VPXHandle *vpxHandle, int32 *width, int32 *height);
MMDecRet VP8GetCodecCapability(VPXHandle *vpxHandle, int32 *max_width,
                               int32 *max_height);
void VP8DecSetCurRecPic(VPXHandle *vpxHandle, uint8 *pFrameY,
...
//Note:
/*****************************************************************************/
MMDecRet VP8DecInit(VPXHandle *vpxHandle, MMCodecBuffer *pInterMemBfr,
                    MMCodecBuffer *pExtaMemBfr, MMDecVideoFormat *pVideoFormat);
...
//Note:
/*****************************************************************************/
MMDecRet VP8DecDecode(VPXHandle *vpxHandle, MMDecInput *pInput,
                      MMDecOutput *pOutput);
...
int VP8Dec_get_iova(VPXHandle *vpxHandle, int fd, unsigned long *iova, size_t *size);

int VP8Dec_free_iova(VPXHandle *vpxHandle, unsigned long iova, size_t size);

int VP8Dec_get_IOMMU_status(VPXHandle *vpxHandle);

MMDecRet VP8DecMemInit(VPXHandle *vpxHandle, MMCodecBuffer *pBuffer);

typedef void (*FT_VPXGetVideoDimensions)(VPXHandle *vpxHandle, int32 *width,
                                         int32 *height);
typedef void (*FT_VPXGetBufferDimensions)(VPXHandle *vpxHandle, int32 *width,
                                          int32 *height);
typedef MMDecRet (*FT_VPXGetCodecCapability)(VPXHandle *vpxHandle,
                                             int32 *max_width,
                                             int32 *max_height);
typedef void (*FT_VPXDecSetCurRecPic)(VPXHandle *vpxHandle, uint8 *pFrameY,
                                      uint8 *pFrameY_phy, void *pBufferHeader);
typedef MMDecRet (*FT_VPXDecInit)(VPXHandle *vpxHandle,
                                  MMCodecBuffer *pInterMemBfr,
                                  MMCodecBuffer *pExtaMemBfr,
                                  MMDecVideoFormat *pVideoFormat);
typedef MMDecRet (*FT_VPXDecDecode)(VPXHandle *vpxHandle, MMDecInput *pInput,
                                    MMDecOutput *pOutput);
...
typedef int (*FT_VPXDec_get_iova)(VPXHandle *vpxHandle, int fd, unsigned long *iova, size_t *size);

typedef int (*FT_VPXDec_free_iova)(VPXHandle *vpxHandle, unsigned long iova, size_t size);

typedef int (*FT_VPXDec_get_IOMMU_status)(VPXHandle *vpxHandle);

typedef MMDecRet (*FT_VPXDecMemInit)(VPXHandle *vpxHandle, MMCodecBuffer *pBuffer);
